...
from utils.training import compute_class_weights, train_model, compute_class_weights_json
from utils.metrics import calculate_mndd, panoptic_quality_metrics
from datasets.pss_dataset import PSSDataset
...
def main(run, train=True, precompute = False, lr = 1e-4, dropout_p=0.4, epochs = 10, batch_size=32, model_id='openai/clip-vit-large-patch14', 
    ...
    root_dir = '/home/mserrao/PSSComics/Comics/datasets.unify/DCM/clean_books'
    annotations_dir = '/home/mserrao/PSSComics/Comics/DatasetDCM/comics_all_430.json'
    precompute_dir = '/home/mserrao/PSSComics/Comics/EncoderClassifier/data'
    checkpoint_dir = '/home/mserrao/PSSComics/Comics/EncoderClassifier/checkpoints'
    data_dir = '/home/mserrao/PSSComics/Comics/EncoderClassifier/data'
    out_dir = '/home/mserrao/PSSComics/Comics/EncoderClassifier/out'
