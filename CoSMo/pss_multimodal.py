...
def main(run, gpu_id = 0,train=True, lr = 1e-4, dropout_p=0.4, epochs = 10, batch_size=32, model_id='openai/clip-vit-large-patch14', 
    ...
    if window_size is not None:
        print(f"Using multimodal sliding window evaluation with window_size={window_size}, stride={stride}")
        results = evaluate_multimodal_with_sliding_window(
            model=model,
